...
# by starting for loop from index 1 we efectively compare index 0( j - 1) with current element
# and we swap if previous element is greater than current. Decrementing j
# allow us to kind of move backwards in array
...
class TestProgram(unittest.TestCase):
    ...
    def test_case_8(self):
        self.assertEqual(
            insertionSort([-7, 2, 3, 8, -10, 4, -6, -10, -2, -7, 10, 5, 2, 9, -9, -5, 3, 8]),
            [-10, -10, -9, -7, -7, -6, -5, -2, 2, 2, 3, 3, 4, 5, 8, 8, 9, 10],
        )

    def test_case_9(self):
        self.assertEqual(
            insertionSort([8, -6, 7, 10, 8, -1, 6, 2, 4, -5, 1, 10, 8, -10, -9, -10, 8, 9, -2, 7, -2, 4]),
    ...
    def test_case_12(self):
        self.assertEqual(
            insertionSort([4, 1, 5, 0, -9, -3, -3, 9, 3, -4, -9, 8, 1, -3, -7, -4, -9, -1, -7, -2, -7, 4]),
