...
# heaps are BT with specific rules:
# min heap rule: parent node always less than a child
# max is oposite to min
# last row goes from left to right strictly

# currentNode = i
# childOne = 2i + 1
# childTwo = 2i + 2
# parrentNode = (i - 1) / 2  and we round it out
# O(n) time |O(1) space
class MinHeap:
...
print(MinHeap([1, 2, 3, 4, 5, 6, 7, 8, 9]))
