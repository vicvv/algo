'''function should retrun array of numbers which replresents the smalest absolute difference 
between two values in input arrays'''
...
'''
# O(N2)
def ssmallestDifference(arrayOne, arrayTwo):
    min = float("inf")
    minarr =[]
